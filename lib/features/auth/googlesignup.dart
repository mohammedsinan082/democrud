...
class googleSignUp extends ConsumerStatefulWidget {
  const googleSignUp({super.key});

  @override
  ConsumerState<googleSignUp> createState() => _googleSignUpState();
}

class _googleSignUpState extends ConsumerState<googleSignUp> {
